...
import de.danoeh.antennapod.core.util.gui.ShownotesCleaner.Companion.cleanStyleTag
import de.danoeh.antennapod.core.util.gui.ShownotesCleaner.Companion.getTimecodeLinkTime
import de.danoeh.antennapod.core.util.gui.ShownotesCleaner.Companion.isTimecodeLink
...
class ShownotesCleanerTest {
    ...
    fun testIsTimecodeLink() {
        ...
        Assert.assertFalse(isTimecodeLink("http://antennapod/timecode/123123"))
        Assert.assertFalse(isTimecodeLink("antennapod://timecode/"))
        Assert.assertFalse(isTimecodeLink("antennapod://123123"))
        Assert.assertFalse(isTimecodeLink("antennapod://timecode/123123a"))
        Assert.assertTrue(isTimecodeLink("antennapod://timecode/123"))
        Assert.assertTrue(isTimecodeLink("antennapod://timecode/1"))
    }
    ...
    fun testGetTimecodeLinkTime() {
        ...
        Assert.assertEquals(123, getTimecodeLinkTime("antennapod://timecode/123").toLong())
    }
