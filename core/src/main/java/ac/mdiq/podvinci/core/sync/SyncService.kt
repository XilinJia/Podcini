...
import ac.mdiq.podvinci.core.storage.DBReader.getFeedItemByGuidOrEpisodeUrl
import ac.mdiq.podvinci.core.storage.DBReader.getFeedListDownloadUrls
import ac.mdiq.podvinci.core.storage.DBReader.loadAdditionalFeedItemListData
import ac.mdiq.podvinci.core.storage.DBTasks.removeFeedWithDownloadUrl
import ac.mdiq.podvinci.core.storage.DBTasks.updateFeed
import ac.mdiq.podvinci.core.storage.DBWriter.removeQueueItem
import ac.mdiq.podvinci.core.storage.DBWriter.setItemList
import ac.mdiq.podvinci.core.sync.EpisodeActionFilter.getRemoteActionsOverridingLocalActions
import ac.mdiq.podvinci.core.sync.GuidValidator.isValidGuid
import ac.mdiq.podvinci.core.sync.LockingAsyncExecutor.executeLockedAsync
import ac.mdiq.podvinci.core.sync.SynchronizationCredentials.deviceID
import ac.mdiq.podvinci.core.sync.SynchronizationCredentials.hosturl
import ac.mdiq.podvinci.core.sync.SynchronizationCredentials.password
import ac.mdiq.podvinci.core.sync.SynchronizationCredentials.username
import ac.mdiq.podvinci.core.sync.SynchronizationProviderViewData.Companion.fromIdentifier
import ac.mdiq.podvinci.core.sync.queue.SynchronizationQueueStorage
import ac.mdiq.podvinci.core.util.FeedItemUtil.hasAlmostEnded
import ac.mdiq.podvinci.core.util.LongList
...
import ac.mdiq.podvinci.net.common.UrlChecker.containsUrl
import ac.mdiq.podvinci.net.sync.gpoddernet.GpodnetService
import ac.mdiq.podvinci.net.sync.model.EpisodeAction
import ac.mdiq.podvinci.net.sync.model.ISyncService
import ac.mdiq.podvinci.net.sync.model.SyncServiceException
import ac.mdiq.podvinci.net.sync.nextcloud.NextcloudSyncService
import ac.mdiq.podvinci.storage.preferences.UserPreferences.gpodnetNotificationsEnabled
import ac.mdiq.podvinci.storage.preferences.UserPreferences.isAllowMobileSync
