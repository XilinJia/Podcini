...
abstract class Namespace {
     ...
     */
    abstract fun handleElementStart(localName: String, state: ac.mdiq.podcini.feed.parser.HandlerState, attributes: Attributes): SyndElement

    /** Called by a Feedhandler when in endElement and it detects a namespace element
     */
    abstract fun handleElementEnd(localName: String, state: ac.mdiq.podcini.feed.parser.HandlerState)
}
