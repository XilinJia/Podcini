...
import ac.mdiq.podvinci.core.feed.LocalFeedUpdater.updateFeed
...
import ac.mdiq.podvinci.core.service.playback.PlaybackServiceInterface
...
import ac.mdiq.podvinci.core.storage.DBReader.getFeedMedia
import ac.mdiq.podvinci.core.storage.DBReader.getQueue
import ac.mdiq.podvinci.core.storage.DBReader.getQueueIDList
import ac.mdiq.podvinci.core.storage.DBTasks.autodownloadUndownloadedItems
import ac.mdiq.podvinci.core.sync.queue.SynchronizationQueueSink
import ac.mdiq.podvinci.core.util.FeedItemPermutors.getPermutor
...
import ac.mdiq.podvinci.event.QueueEvent.Companion.added
import ac.mdiq.podvinci.event.QueueEvent.Companion.cleared
import ac.mdiq.podvinci.event.QueueEvent.Companion.irreversibleRemoved
import ac.mdiq.podvinci.event.QueueEvent.Companion.moved
import ac.mdiq.podvinci.event.QueueEvent.Companion.removed
...
import ac.mdiq.podvinci.storage.preferences.UserPreferences.isQueueKeepSorted
import ac.mdiq.podvinci.storage.preferences.UserPreferences.queueKeepSortedOrder
...
/**
 * Provides methods for writing data to PodVinci's database.
