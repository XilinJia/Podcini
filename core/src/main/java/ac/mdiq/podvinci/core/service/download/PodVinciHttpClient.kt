...
import ac.mdiq.podvinci.core.service.BasicAuthorizationInterceptor
import ac.mdiq.podvinci.core.service.UserAgentInterceptor
import ac.mdiq.podvinci.model.download.ProxyConfig
import ac.mdiq.podvinci.net.ssl.SslClientSetup
import okhttp3.*
 ...
 */
object PodVinciHttpClient {
    private const val TAG = "PodVinciHttpClient"
     ...
     * getHttpClient() to get the standard PodVinci client,
    ...
    fun setCacheDirectory(cacheDirectory: File?) {
        PodVinciHttpClient.cacheDirectory = cacheDirectory
    }

    @JvmStatic
    fun setProxyConfig(proxyConfig: ProxyConfig?) {
        PodVinciHttpClient.proxyConfig = proxyConfig
    }
}
