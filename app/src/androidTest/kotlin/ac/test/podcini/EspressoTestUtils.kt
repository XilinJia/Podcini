...
//        adapter.close()
    ...
    fun clickPreference(@StringRes title: Int) {
        Espresso.onView(ViewMatchers.withId(com.bytehamster.lib.preferencesearch.R.id.recycler_view)).perform(
    ...
    fun openNavDrawer() {
        Espresso.onView(ViewMatchers.isRoot()).perform(waitForView(ViewMatchers.withId(R.id.main_layout), 1000))
