package ac.mdiq.podvinci.menuhandler
...
import ac.mdiq.podvinci.core.util.*
import ac.mdiq.podvinci.dialog.ShareDialog
...
object FeedItemMenuHandler {
    ...
    fun markReadWithUndo(fragment: Fragment, item: FeedItem?,
        ...
        val playStateStringRes: Int = when (playState) {
            FeedItem.UNPLAYED -> if (item.playState == FeedItem.NEW) {
                //was new
                R.string.removed_inbox_label
            } else {
                //was played
                R.string.marked_as_unplayed_label
            }
            FeedItem.PLAYED -> R.string.marked_as_played_label
            else -> if (item.playState == FeedItem.NEW) {
                R.string.removed_inbox_label
            } else {
                R.string.marked_as_unplayed_label
            }
