...
import de.danoeh.antennapod.core.feed.LocalFeedUpdater.getImageUrl
import de.danoeh.antennapod.core.feed.LocalFeedUpdater.tryUpdateFeed
...
import de.danoeh.antennapod.core.util.FastDocumentFile.Companion.list
...
class LocalFeedUpdaterTest {
    ...
    fun testUpdateFeed_AddNewFeed() {
        ...
        assertEquals(FEED_URL, feedAfter.download_url)
    }
    ...
    fun testUpdateFeed_FeedMetadata() {
        ...
        val feedItems = getFeedItemList(feed)
