...
import ac.mdiq.podcini.core.storage.DBReader.getTotalEpisodeCount
...
import ac.mdiq.podcini.core.util.PlaybackStatus.isPlaying
import ac.mdiq.podcini.core.util.PowerUtils.deviceCharging
