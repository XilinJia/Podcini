...
class ShownotesCleaner(context: Context, private val rawShownotes: String, private val playableDuration: Int) {
    ...
    companion object {
        ...
        private val TIMECODE_LINK_REGEX: Pattern = Pattern.compile("antennapod://timecode/(\\d+)")
        private const val TIMECODE_LINK = "<a class=\"timecode\" href=\"antennapod://timecode/%d\">%s</a>"
