package ac.mdiq.podvinci.error

import android.util.Log
import ac.mdiq.podvinci.BuildConfig
import ac.mdiq.podvinci.error.CrashReportWriter.Companion.write
...
object RxJavaErrorHandlerSetup {
    ...
    fun setupRxJavaErrorHandler() {
        RxJavaPlugins.setErrorHandler { exception: Throwable? ->
            ...
            // PodVinci threads might throw NPEs after disposing because we set controllers to null.
