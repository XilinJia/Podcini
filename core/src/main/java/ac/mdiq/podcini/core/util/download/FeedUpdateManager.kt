...
import ac.mdiq.podcini.core.service.FeedUpdateWorker
import ac.mdiq.podcini.core.util.NetworkUtils.isFeedRefreshAllowed
...
import ac.mdiq.podcini.core.util.NetworkUtils.networkAvailable
...
object FeedUpdateManager {
    ...
    private const val WORK_ID_FEED_UPDATE = "ac.mdiq.podcini.core.service.FeedUpdateWorker"
