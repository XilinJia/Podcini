...
import de.danoeh.antennapod.model.feed.FeedFunding.Companion.extractPaymentLinks
import java.util.*
...
class Feed : FeedFile {
    ...
    companion object {
        ...
        const val PREFIX_LOCAL_FOLDER: String = "antennapod_local:"
        const val PREFIX_GENERATIVE_COVER: String = "antennapod_generative_cover:"
    }
}
