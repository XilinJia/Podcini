...
import de.danoeh.antennapod.core.storage.DBReader.extractItemlistFromCursor
...
import de.danoeh.antennapod.storage.preferences.UserPreferences.newEpisodesAction
            ...
            for (idx in newFeed.items!!.indices) {
                ...
                if (!newFeed.isLocalFeed && possibleDuplicate != null && item !== possibleDuplicate) {
                    ...
                    DBWriter.addDownloadStatus(DownloadResult(savedFeed,
                        ...
                        """
                            The podcast host appears to have added the same episode twice. AntennaPod still refreshed the feed and attempted to repair it.
