...
import ac.mdiq.podvinci.model.feed.FeedFunding.Companion.extractPaymentLinks
import java.util.*
...
class Feed : FeedFile {
    ...
    companion object {
        ...
        const val PREFIX_LOCAL_FOLDER: String = "podvinci_local:"
        const val PREFIX_GENERATIVE_COVER: String = "podvinci_generative_cover:"
    }
}
