...
import ac.mdiq.podcini.parser.feed.element.AtomText
...
import ac.mdiq.podcini.parser.feed.util.MimeTypeUtils.getMimeType
import ac.mdiq.podcini.parser.feed.util.MimeTypeUtils.isMediaFile
import ac.mdiq.podcini.parser.feed.util.SyndStringUtils.trimAllWhitespace
