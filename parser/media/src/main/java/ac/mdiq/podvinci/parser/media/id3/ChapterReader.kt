...
import ac.mdiq.podvinci.model.feed.EmbeddedChapterImage.Companion.makeUrl
import ac.mdiq.podvinci.parser.media.id3.model.FrameHeader
        ...
        when (frameHeader.id) {
            ...
            FRAME_ID_PICTURE -> {
                ...
                if (MIME_IMAGE_URL == mime) {
                    ...
                    Log.d(TAG, "Link: $link")
                    if (TextUtils.isEmpty(chapter.imageUrl) || type.toInt() == IMAGE_TYPE_COVER) {
