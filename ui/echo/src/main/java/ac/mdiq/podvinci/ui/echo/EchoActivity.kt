package ac.mdiq.podvinci.ui.echo
...
import ac.mdiq.podvinci.core.storage.DBReader.StatisticsResult
import ac.mdiq.podvinci.core.storage.StatisticsItem
import ac.mdiq.podvinci.core.util.Converter.getDurationStringLocalized
import ac.mdiq.podvinci.storage.preferences.UserPreferences.getDataFolder
import ac.mdiq.podvinci.storage.preferences.UserPreferences.timeRespectsSpeed
import ac.mdiq.podvinci.ui.echo.databinding.EchoActivityBinding
import ac.mdiq.podvinci.ui.echo.screens.*
...
class EchoActivity : AppCompatActivity() {
    ...
    private fun share() {
        try {
            ...
            val file = File(getDataFolder(null), "PodVinciEcho.png")
