...
import ac.mdiq.podvinci.core.service.playback.PlaybackService.Companion.isCasting
...
import ac.mdiq.podvinci.core.util.ShareUtils.hasLinkToShare
import ac.mdiq.podvinci.core.util.TimeSpeedConverter
import ac.mdiq.podvinci.core.util.gui.PictureInPictureUtil
import ac.mdiq.podvinci.core.util.playback.PlaybackController
import ac.mdiq.podvinci.databinding.VideoplayerActivityBinding
...
import ac.mdiq.podvinci.fragment.ChaptersFragment
...
import ac.mdiq.podvinci.storage.preferences.UserPreferences.setShowRemainTimeSetting
import ac.mdiq.podvinci.storage.preferences.UserPreferences.shouldShowRemainingTime
...
class VideoplayerActivity : CastEnabledActivity(), OnSeekBarChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setTheme(R.style.Theme_PodVinci_VideoPlayer)
