package ac.mdiq.podvinci.storage.database
...
import ac.mdiq.podvinci.model.feed.SortOrder.Companion.toCodeString
import ac.mdiq.podvinci.storage.database.mapper.FeedItemFilterQuery.generateFrom
import ac.mdiq.podvinci.storage.database.mapper.FeedItemSortQuery.generateFrom
...
class PodDBAdapter private constructor() {
    ...
    /**
     * Helper class for opening the PodVinci database.
     */
    ...
    companion object {
        ...
        const val DATABASE_NAME: String = "PodVinci.db"
