...
import ac.mdiq.podvinci.net.sync.HostnameParser
import ac.mdiq.podvinci.net.sync.gpoddernet.mapper.ResponseMapper.readEpisodeActionsFromJsonObject
import ac.mdiq.podvinci.net.sync.gpoddernet.mapper.ResponseMapper.readSubscriptionChangesFromJsonObject
import ac.mdiq.podvinci.net.sync.gpoddernet.model.GpodnetDevice
import ac.mdiq.podvinci.net.sync.gpoddernet.model.GpodnetDevice.DeviceType
import ac.mdiq.podvinci.net.sync.gpoddernet.model.GpodnetEpisodeActionPostResponse
import ac.mdiq.podvinci.net.sync.gpoddernet.model.GpodnetPodcast
import ac.mdiq.podvinci.net.sync.gpoddernet.model.GpodnetUploadChangesResponse
import ac.mdiq.podvinci.net.sync.model.*
import okhttp3.*
...
class GpodnetService(private val httpClient: OkHttpClient, baseHosturl: String?,
    ...
    companion object {
        const val TAG: String = "GpodnetService"
