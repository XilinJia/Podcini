package ac.mdiq.podvinci.net.sync.gpoddernet.mapper

import ac.mdiq.podvinci.net.sync.model.EpisodeAction
import ac.mdiq.podvinci.net.sync.model.EpisodeAction.Companion.readFromJsonObject
import ac.mdiq.podvinci.net.sync.model.EpisodeActionChanges
import ac.mdiq.podvinci.net.sync.model.SubscriptionChanges
