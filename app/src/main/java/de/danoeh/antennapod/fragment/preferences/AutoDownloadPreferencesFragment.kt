...
import de.danoeh.antennapod.storage.preferences.UserPreferences.autodownloadSelectedNetworks
import de.danoeh.antennapod.storage.preferences.UserPreferences.isEnableAutodownload
import de.danoeh.antennapod.storage.preferences.UserPreferences.isEnableAutodownloadWifiFilter
import de.danoeh.antennapod.storage.preferences.UserPreferences.setAutodownloadSelectedNetworks
import java.util.*
...
class AutoDownloadPreferencesFragment : PreferenceFragmentCompat() {
    ...
    private fun buildAutodownloadSelectedNetworksPreference() {
        ...
        networks.sortWith(Comparator { x: WifiConfiguration, y: WifiConfiguration ->
