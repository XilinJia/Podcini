...
class PlaybackPreferences private constructor() : OnSharedPreferenceChangeListener {
    ...
    companion object {
         ...
         * object.
         */
        private const val PREF_CURRENTLY_PLAYING_FEED_ID = "ac.mdiq.podvinci.preferences.lastPlayedFeedId"
         ...
         */
        private const val PREF_CURRENTLY_PLAYING_FEEDMEDIA_ID = "ac.mdiq.podvinci.preferences.lastPlayedFeedMediaId"
         ...
         */
        private const val PREF_CURRENTLY_PLAYING_MEDIA_TYPE = "ac.mdiq.podvinci.preferences.currentlyPlayingMedia"

        /**
         * True if last played media was a video.
         */
        private const val PREF_CURRENT_EPISODE_IS_VIDEO = "ac.mdiq.podvinci.preferences.lastIsVideo"

        /**
         * The current player status as int.
         */
        private const val PREF_CURRENT_PLAYER_STATUS = "ac.mdiq.podvinci.preferences.currentPlayerStatus"
        ...
        private const val PREF_CURRENTLY_PLAYING_TEMPORARY_PLAYBACK_SPEED =
            "ac.mdiq.podvinci.preferences.temporaryPlaybackSpeed"
