...
import ac.mdiq.podvinci.core.preferences.PlaybackPreferences.Companion.clearCurrentlyPlayingTemporaryPlaybackSpeed
import ac.mdiq.podvinci.core.preferences.PlaybackPreferences.Companion.createInstanceFromPreferences
import ac.mdiq.podvinci.core.preferences.PlaybackPreferences.Companion.currentEpisodeIsVideo
import ac.mdiq.podvinci.core.preferences.PlaybackPreferences.Companion.currentPlayerStatus
import ac.mdiq.podvinci.core.preferences.PlaybackPreferences.Companion.currentlyPlayingFeedMediaId
import ac.mdiq.podvinci.core.preferences.PlaybackPreferences.Companion.currentlyPlayingTemporaryPlaybackSpeed
import ac.mdiq.podvinci.core.preferences.PlaybackPreferences.Companion.writeMediaPlaying
import ac.mdiq.podvinci.core.preferences.PlaybackPreferences.Companion.writeNoMediaPlaying
import ac.mdiq.podvinci.core.preferences.PlaybackPreferences.Companion.writePlayerStatus
import ac.mdiq.podvinci.core.preferences.SleepTimerPreferences.autoEnable
import ac.mdiq.podvinci.core.preferences.SleepTimerPreferences.autoEnableFrom
import ac.mdiq.podvinci.core.preferences.SleepTimerPreferences.autoEnableTo
import ac.mdiq.podvinci.core.preferences.SleepTimerPreferences.isInTimeRange
import ac.mdiq.podvinci.core.preferences.SleepTimerPreferences.timerMillis
import ac.mdiq.podvinci.core.receiver.MediaButtonReceiver
import ac.mdiq.podvinci.core.service.QuickSettingsTileService
import ac.mdiq.podvinci.core.service.playback.PlaybackServiceTaskManager.PSTMCallback
...
import ac.mdiq.podvinci.core.util.ChapterUtils.getCurrentChapterIndex
import ac.mdiq.podvinci.core.util.FeedItemUtil.hasAlmostEnded
import ac.mdiq.podvinci.core.util.FeedUtil.shouldAutoDeleteItemsOnThatFeed
import ac.mdiq.podvinci.core.util.IntentUtils.sendLocalBroadcast
import ac.mdiq.podvinci.core.util.NetworkUtils.isStreamingAllowed
import ac.mdiq.podvinci.core.util.gui.NotificationUtils
import ac.mdiq.podvinci.core.util.playback.PlayableUtils.saveCurrentPosition
...
import ac.mdiq.podvinci.event.settings.SkipIntroEndingChangedEvent
import ac.mdiq.podvinci.event.settings.SpeedPresetChangedEvent
import ac.mdiq.podvinci.event.settings.VolumeAdaptionChangedEvent
import ac.mdiq.podvinci.model.feed.*
import ac.mdiq.podvinci.model.feed.FeedPreferences.AutoDeleteAction
...
import ac.mdiq.podvinci.storage.preferences.UserPreferences.fastForwardSecs
import ac.mdiq.podvinci.storage.preferences.UserPreferences.getPlaybackSpeed
import ac.mdiq.podvinci.storage.preferences.UserPreferences.hardwareForwardButton
import ac.mdiq.podvinci.storage.preferences.UserPreferences.hardwarePreviousButton
import ac.mdiq.podvinci.storage.preferences.UserPreferences.isAllowMobileStreaming
import ac.mdiq.podvinci.storage.preferences.UserPreferences.isFollowQueue
import ac.mdiq.podvinci.storage.preferences.UserPreferences.isPauseOnHeadsetDisconnect
import ac.mdiq.podvinci.storage.preferences.UserPreferences.isPersistNotify
import ac.mdiq.podvinci.storage.preferences.UserPreferences.isSkipSilence
import ac.mdiq.podvinci.storage.preferences.UserPreferences.isUnpauseOnBluetoothReconnect
import ac.mdiq.podvinci.storage.preferences.UserPreferences.isUnpauseOnHeadsetReconnect
import ac.mdiq.podvinci.storage.preferences.UserPreferences.playbackSpeedArray
import ac.mdiq.podvinci.storage.preferences.UserPreferences.rewindSecs
import ac.mdiq.podvinci.storage.preferences.UserPreferences.setPlaybackSpeed
import ac.mdiq.podvinci.storage.preferences.UserPreferences.shouldFavoriteKeepEpisode
import ac.mdiq.podvinci.storage.preferences.UserPreferences.shouldSkipKeepEpisode
import ac.mdiq.podvinci.storage.preferences.UserPreferences.showNextChapterOnFullNotification
import ac.mdiq.podvinci.storage.preferences.UserPreferences.showPlaybackSpeedOnFullNotification
import ac.mdiq.podvinci.storage.preferences.UserPreferences.showSkipOnFullNotification
...
class PlaybackService : MediaBrowserServiceCompat() {
    ...
    companion object {
         ...
         */
        private const val CUSTOM_ACTION_SKIP_TO_NEXT = "action.ac.mdiq.podvinci.core.service.skipToNext"
        private const val CUSTOM_ACTION_FAST_FORWARD = "action.ac.mdiq.podvinci.core.service.fastForward"
        private const val CUSTOM_ACTION_REWIND = "action.ac.mdiq.podvinci.core.service.rewind"
        private const val CUSTOM_ACTION_CHANGE_PLAYBACK_SPEED =
            "action.ac.mdiq.podvinci.core.service.changePlaybackSpeed"
        const val CUSTOM_ACTION_NEXT_CHAPTER: String = "action.ac.mdiq.podvinci.core.service.next_chapter"
