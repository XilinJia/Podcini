...
import ac.mdiq.podvinci.adapter.CoverLoader
import ac.mdiq.podvinci.adapter.actionbutton.ItemActionButton
...
import ac.mdiq.podvinci.core.util.PlaybackStatus
import ac.mdiq.podvinci.core.util.download.MediaSizeLoader
...
class EpisodeItemViewHolder(activity: MainActivity, parent: ViewGroup?) :
    ...
    private fun updateDuration(event: PlaybackPositionEvent) {
        if (feedItem != null && feedItem!!.media != null) {
