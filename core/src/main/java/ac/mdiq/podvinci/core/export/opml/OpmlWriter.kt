package ac.mdiq.podvinci.core.export.opml

import android.content.Context
import android.util.Log
import android.util.Xml
import ac.mdiq.podvinci.core.export.CommonSymbols
import ac.mdiq.podvinci.core.export.ExportWriter
import ac.mdiq.podvinci.core.util.DateFormatter.formatRfc822Date
...
class OpmlWriter : ExportWriter {
    ...
    companion object {
        private const val TAG = "OpmlWriter"
        private const val ENCODING = "UTF-8"
        private const val OPML_VERSION = "2.0"
        private const val OPML_TITLE = "PodVinci Subscriptions"
    }
}
