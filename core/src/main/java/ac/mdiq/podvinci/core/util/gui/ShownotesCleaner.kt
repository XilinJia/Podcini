...
import ac.mdiq.podvinci.core.util.Converter.durationStringLongToMs
import ac.mdiq.podvinci.core.util.Converter.durationStringShortToMs
...
class ShownotesCleaner(context: Context, private val rawShownotes: String, private val playableDuration: Int) {
    ...
    companion object {
        ...
        private val TIMECODE_LINK_REGEX: Pattern = Pattern.compile("podvinci://timecode/(\\d+)")
        private const val TIMECODE_LINK = "<a class=\"timecode\" href=\"podvinci://timecode/%d\">%s</a>"
