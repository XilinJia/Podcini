...
import de.danoeh.antennapod.net.common.UrlChecker.prepareUrl
import de.danoeh.antennapod.net.common.UrlChecker.urlEquals
...
class UrlCheckerTest {
    ...
    fun testAntennaPodSubscribeProtocolNoScheme() {
        val inVal = "antennapod-subscribe://example.com"
        val out = prepareUrl(inVal)
        Assert.assertEquals("http://example.com", out)
    }
    ...
    fun testAntennaPodSubscribeProtocolWithScheme() {
        val inVal = "antennapod-subscribe://https://example.com"
        val out = prepareUrl(inVal)
        Assert.assertEquals("https://example.com", out)
    }
    ...
    fun testAntennaPodSubscribeDeeplink() {
        ...
        Assert.assertEquals(feed, prepareUrl("https://antennapod.org/deeplink/subscribe?url=$feed"))
        Assert.assertEquals(feed, prepareUrl("http://antennapod.org/deeplink/subscribe?url=$feed"))
        Assert.assertEquals(feed, prepareUrl("http://antennapod.org/deeplink/subscribe/?url=$feed"))
        Assert.assertEquals(feed, prepareUrl("https://www.antennapod.org/deeplink/subscribe?url=$feed"))
        Assert.assertEquals(feed, prepareUrl("http://www.antennapod.org/deeplink/subscribe?url=$feed"))
        Assert.assertEquals(feed, prepareUrl("http://www.antennapod.org/deeplink/subscribe/?url=$feed"))
        Assert.assertEquals(feed, prepareUrl("http://www.antennapod.org/deeplink/subscribe?url="
