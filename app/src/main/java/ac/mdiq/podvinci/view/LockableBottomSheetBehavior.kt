...
class LockableBottomSheetBehavior<V : View?> : ViewPagerBottomSheetBehavior<V> {
    ...
    override fun onStartNestedScroll(coordinatorLayout: CoordinatorLayout, child: V & Any, directTargetChild: View,
    ...
    override fun onNestedPreScroll(coordinatorLayout: CoordinatorLayout, child: V & Any, target: View,
    ...
    override fun onNestedPreFling(coordinatorLayout: CoordinatorLayout, child: V & Any, target: View,
