...
class ChapterSeekBar : AppCompatSeekBar {
    ...
    private fun init(context: Context) {
        ...
        paintBackground.color = getColorFromAttr(getContext(), com.google.android.material.R.attr.colorSurfaceVariant)
        paintBackground.alpha = 128
        paintProgressPrimary.color = getColorFromAttr(getContext(), androidx.appcompat.R.attr.colorPrimary)
    }
