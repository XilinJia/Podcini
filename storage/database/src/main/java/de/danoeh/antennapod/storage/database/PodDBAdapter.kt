...
import de.danoeh.antennapod.model.feed.SortOrder.Companion.toCodeString
import de.danoeh.antennapod.storage.database.mapper.FeedItemFilterQuery.generateFrom
import de.danoeh.antennapod.storage.database.mapper.FeedItemSortQuery.generateFrom
...
class PodDBAdapter private constructor() {
    ...
    companion object {
        ...
        const val DATABASE_NAME: String = "Antennapod.db"
