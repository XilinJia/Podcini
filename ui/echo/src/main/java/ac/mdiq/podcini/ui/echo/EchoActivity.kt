...
import ac.mdiq.podcini.core.feed.util.PlaybackSpeedUtils.getCurrentPlaybackSpeed
import ac.mdiq.podcini.core.storage.DBReader
import ac.mdiq.podcini.core.storage.DBReader.StatisticsResult
...
import ac.mdiq.podcini.storage.preferences.UserPreferences.timeRespectsSpeed
import ac.mdiq.podcini.ui.echo.databinding.EchoActivityBinding
import ac.mdiq.podcini.ui.echo.screens.*
...
class EchoActivity : AppCompatActivity() {
    ...
    private fun share() {
        try {
            ...
            val file = File(getDataFolder(null), "PodciniEcho.png")
