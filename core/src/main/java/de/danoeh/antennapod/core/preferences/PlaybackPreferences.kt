...
class PlaybackPreferences private constructor() : OnSharedPreferenceChangeListener {
    ...
    companion object {
         ...
         */
        private const val PREF_CURRENTLY_PLAYING_FEEDMEDIA_ID = "de.danoeh.antennapod.preferences.lastPlayedFeedMediaId"
         ...
         */
        private const val PREF_CURRENTLY_PLAYING_MEDIA_TYPE = "de.danoeh.antennapod.preferences.currentlyPlayingMedia"
