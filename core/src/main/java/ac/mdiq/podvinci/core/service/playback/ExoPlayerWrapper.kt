...
class ExoPlayerWrapper internal constructor(private val context: Context) {
    ...
    fun setDataSource(s: String, user: String?, password: String?) {
        ...
        //        Call.Factory callFactory = PodVinciHttpClient.getHttpClient(); // Assuming it returns OkHttpClient
...
//                .setUserAgent(ClientConfig.USER_AGENT);
        val httpDataSourceFactory =
            OkHttpDataSource.Factory(PodVinciHttpClient.getHttpClient() as okhttp3.Call.Factory)
                .setUserAgent(ClientConfig.USER_AGENT)
