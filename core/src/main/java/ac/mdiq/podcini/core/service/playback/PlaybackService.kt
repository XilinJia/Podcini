...
import ac.mdiq.podcini.core.preferences.PlaybackPreferences.Companion.clearCurrentlyPlayingTemporaryPlaybackSpeed
import ac.mdiq.podcini.core.preferences.PlaybackPreferences.Companion.createInstanceFromPreferences
import ac.mdiq.podcini.core.preferences.PlaybackPreferences.Companion.currentEpisodeIsVideo
import ac.mdiq.podcini.core.preferences.PlaybackPreferences.Companion.currentPlayerStatus
import ac.mdiq.podcini.core.preferences.PlaybackPreferences.Companion.currentlyPlayingFeedMediaId
import ac.mdiq.podcini.core.preferences.PlaybackPreferences.Companion.currentlyPlayingTemporaryPlaybackSpeed
import ac.mdiq.podcini.core.preferences.PlaybackPreferences.Companion.writeMediaPlaying
import ac.mdiq.podcini.core.preferences.PlaybackPreferences.Companion.writeNoMediaPlaying
import ac.mdiq.podcini.core.preferences.PlaybackPreferences.Companion.writePlayerStatus
...
import ac.mdiq.podcini.core.service.QuickSettingsTileService
...
import ac.mdiq.podcini.core.storage.FeedSearcher
import ac.mdiq.podcini.core.sync.queue.SynchronizationQueueSink
import ac.mdiq.podcini.core.util.ChapterUtils.getCurrentChapterIndex
import ac.mdiq.podcini.core.util.FeedItemUtil.hasAlmostEnded
import ac.mdiq.podcini.core.util.FeedUtil.shouldAutoDeleteItemsOnThatFeed
...
import ac.mdiq.podcini.core.util.playback.PlayableUtils.saveCurrentPosition
...
import ac.mdiq.podcini.event.settings.SkipIntroEndingChangedEvent
import ac.mdiq.podcini.event.settings.SpeedPresetChangedEvent
import ac.mdiq.podcini.event.settings.VolumeAdaptionChangedEvent
import ac.mdiq.podcini.model.feed.*
import ac.mdiq.podcini.model.feed.FeedPreferences.AutoDeleteAction
...
import ac.mdiq.podcini.storage.preferences.UserPreferences.downloadsSortedOrder
import ac.mdiq.podcini.storage.preferences.UserPreferences.fastForwardSecs
import ac.mdiq.podcini.storage.preferences.UserPreferences.getPlaybackSpeed
import ac.mdiq.podcini.storage.preferences.UserPreferences.hardwareForwardButton
import ac.mdiq.podcini.storage.preferences.UserPreferences.hardwarePreviousButton
...
import ac.mdiq.podcini.storage.preferences.UserPreferences.setPlaybackSpeed
import ac.mdiq.podcini.storage.preferences.UserPreferences.shouldFavoriteKeepEpisode
import ac.mdiq.podcini.storage.preferences.UserPreferences.shouldSkipKeepEpisode
...
import ac.mdiq.podcini.storage.preferences.UserPreferences.videoPlaybackSpeed
...
//        TODO: need to experiment this value
         ...
         */
        private const val CUSTOM_ACTION_SKIP_TO_NEXT = "action.ac.mdiq.podcini.core.service.skipToNext"
        private const val CUSTOM_ACTION_FAST_FORWARD = "action.ac.mdiq.podcini.core.service.fastForward"
        private const val CUSTOM_ACTION_REWIND = "action.ac.mdiq.podcini.core.service.rewind"
        private const val CUSTOM_ACTION_CHANGE_PLAYBACK_SPEED =
            "action.ac.mdiq.podcini.core.service.changePlaybackSpeed"
        const val CUSTOM_ACTION_NEXT_CHAPTER: String = "action.ac.mdiq.podcini.core.service.next_chapter"
