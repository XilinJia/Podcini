...
import ac.mdiq.podvinci.core.service.FeedUpdateWorker
import ac.mdiq.podvinci.core.util.NetworkUtils.isFeedRefreshAllowed
import ac.mdiq.podvinci.core.util.NetworkUtils.isNetworkRestricted
import ac.mdiq.podvinci.core.util.NetworkUtils.isVpnOverWifi
import ac.mdiq.podvinci.core.util.NetworkUtils.networkAvailable
...
object FeedUpdateManager {
    ...
    private const val WORK_ID_FEED_UPDATE = "ac.mdiq.podvinci.core.service.FeedUpdateWorker"
