...
import ac.mdiq.podvinci.core.receiver.MediaButtonReceiver.Companion.createPendingIntent
import ac.mdiq.podvinci.core.receiver.PlayerWidget
import ac.mdiq.podvinci.core.receiver.PlayerWidget.Companion.isEnabled
...
import ac.mdiq.podvinci.ui.appstartintent.PlaybackSpeedActivityStarter
        ...
        if (widgetState.media != null) {
            ...
            try {
                ...
                try {
                    icon = Glide.with(context)
                        .asBitmap()
                        .load(getFallbackImageLocation(widgetState.media))
                        .apply(options)
