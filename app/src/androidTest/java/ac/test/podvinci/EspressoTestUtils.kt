...
import ac.mdiq.podvinci.dialog.RatingDialog.saveRated
import ac.mdiq.podvinci.fragment.NavDrawerFragment
...
object EspressoTestUtils {
    ...
    fun openNavDrawer() {
        Espresso.onView(ViewMatchers.isRoot()).perform(waitForView(ViewMatchers.withId(R.id.drawer_layout), 1000))
