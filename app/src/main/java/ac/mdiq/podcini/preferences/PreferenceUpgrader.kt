...
import ac.mdiq.podcini.error.CrashReportWriter.Companion.file
...
import ac.mdiq.podcini.storage.preferences.UserPreferences.isAllowMobileAutoDownload
import ac.mdiq.podcini.storage.preferences.UserPreferences.isAllowMobileEpisodeDownload
import ac.mdiq.podcini.storage.preferences.UserPreferences.isAllowMobileFeedRefresh
import ac.mdiq.podcini.storage.preferences.UserPreferences.isAllowMobileImages
import ac.mdiq.podcini.storage.preferences.UserPreferences.isAllowMobileSync
import ac.mdiq.podcini.storage.preferences.UserPreferences.isQueueLocked
import ac.mdiq.podcini.storage.preferences.UserPreferences.isStreamOverDownload
import ac.mdiq.podcini.storage.preferences.UserPreferences.theme
